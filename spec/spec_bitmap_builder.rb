...
RSpec.describe BitmapBuilder do
    it 'Creates an appropriate image of a correct I line ' do
       File.open("./spec/examples/testI.txt", 'w') do |file|
        file.write("I 5 6\nS")
       end
    ...
    it 'Doesn\'t output anything when there is no S at the bottom ' do
         File.open("./spec/examples/testnS.txt", 'w') do |file|
          file.write("I 5 6\n")
        end
    ...
    it ' Correctly Accomplishes the Carwow challenge' do
         ...
         expect { system ('bin/bitmap_editor spec/examples/carwow.txt')}.to output("").to_stdout_from_any_process
    end
  end